...
Then, to answer the question, we will find the sample mean of this simulation and compare it with the theoretical mean (1/lambda).
...
##while the theoretical mean is one over lambda, which is:
print(mean)
```
To show it graphically, we will use a histogram, where the green dotted line is the simulated mean and  the blue is the theoretical. They are almost on top of each other and might be a bit difficult to see separately.
